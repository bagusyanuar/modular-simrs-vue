...
<template>
  <div
    class="w-full h-dvh bg-stone-100 flex items-center justify-center p-4 selection:bg-teal-100"
  >
    <div
    ...
    >
      ...
      <div
        class="relative flex flex-col justify-center bg-white shadow-[-1px_0_0_0_rgba(0,0,0,0.05)]"
      >
        <!-- 🔄 State: Redirecting -->
        <div
        ...
        >
          <div
            class="w-16 h-16 border-4 border-teal-600 border-t-transparent rounded-full animate-spin"
          ></div>
          <h2 class="text-2xl font-bold text-teal-600 tracking-tight">
            Redirecting...
          </h2>
          <p class="text-stone-500 font-medium">
            Menghubungkan Bosku kembali ke aplikasi.
          </p>
        </div>
        ...
        >
          <div
            class="w-24 h-24 bg-teal-50 text-teal-600 rounded-full flex items-center justify-center text-4xl shadow-inner animate-bounce-soft"
          >
            ✓
          </div>
          <div>
            <h2 class="text-3xl font-black text-stone-900 tracking-tighter">
              BOSKU SUDAH LOGIN
            </h2>
            <p class="text-stone-500 mt-2 font-medium">
              Sesi Anda sedang aktif di Portal SSO.
            </p>
          </div>
