...
# Jalankan preview atau command lain secara dynamic
# Opsional: Bisa ganti ke 'pnpm dev' kalau tujuannya buat development image
CMD pnpm turbo run preview --filter=$APP_NAME
